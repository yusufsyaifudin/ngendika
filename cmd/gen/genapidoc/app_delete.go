...
// AppDelete
// DELETE /api/v1/apps/{client_id}
func AppDelete(ctx context.Context, components openapi3.Components, path map[string]*openapi3.PathItem) {
	const scopedSchemaName = "AppDelete"
	const routeName = "Delete Application"
	const pathRoute = "/api/v1/apps/{client_id}"

	// --- Response schema
	respStruct := handlerapp.DelAppByClientIDResp{
		Success: true,
	}
